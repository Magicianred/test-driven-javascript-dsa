...
const testCases = [
  ...
  [
    100,
    `Fizz: ${Math.floor(100 / 3)}, Buzz: ${Math.floor(
      100 / 5
    )}, FizzBuzz: ${Math.floor(100 / 15)}`,
  ],

  // Case 2: [1] => Fizz: ${1/3}, Buzz: ${1/5}, FizzBuzz: ${1/15}
  [
    1,
    `Fizz: ${Math.floor(1 / 3)}, Buzz: ${Math.floor(
      1 / 5
    )}, FizzBuzz: ${Math.floor(1 / 15)}`,
  ],

  // Case 3: [10] => Fizz: ${10/3}, Buzz: ${10/5}, FizzBuzz: ${10/15}
  [
    10,
    `Fizz: ${Math.floor(10 / 3)}, Buzz: ${Math.floor(
      10 / 5
    )}, FizzBuzz: ${Math.floor(10 / 15)}`,
  ],

  // Case 4: [9] => Fizz: ${9/3}, Buzz: ${9/5}, FizzBuzz: ${9/15}
  [
    9,
    `Fizz: ${Math.floor(9 / 3)}, Buzz: ${Math.floor(
      9 / 5
    )}, FizzBuzz: ${Math.floor(9 / 15)}`,
  ],

  // Case 5: [3] => Fizz: ${3/3}, Buzz: ${3/5}, FizzBuzz: ${3/15}
  [
    3,
    `Fizz: ${Math.floor(3 / 3)}, Buzz: ${Math.floor(
      3 / 5
    )}, FizzBuzz: ${Math.floor(3 / 15)}`,
  ],

  // Case 6: [5] => Fizz: ${5/3}, Buzz: ${5/5}, FizzBuzz: ${5/15}
  [
    5,
    `Fizz: ${Math.floor(5 / 3)}, Buzz: ${Math.floor(
      5 / 5
    )}, FizzBuzz: ${Math.floor(5 / 15)}`,
  ],

  // Case 7: [15] => Fizz: ${15/3}, Buzz: ${15/5}, FizzBuzz: $15/15}
  [
    15,
    `Fizz: ${Math.floor(15 / 3)}, Buzz: ${Math.floor(
      15 / 5
    )}, FizzBuzz: ${Math.floor(15 / 15)}`,
  ],

  // Case 8: [99999] => Fizz: ${99999/3}, Buzz: ${99999/5}, FizzBuzz: ${99999/15}
  [
    99999,
    `Fizz: ${Math.floor(99999 / 3)}, Buzz: ${Math.floor(
      99999 / 5
    )}, FizzBuzz: ${Math.floor(99999 / 15)}`,
  ],
];
